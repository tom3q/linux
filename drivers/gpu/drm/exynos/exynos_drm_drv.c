...
static const struct drm_ioctl_desc exynos_ioctls[] = {
	...
	DRM_IOCTL_DEF_DRV(EXYNOS_G3D_CREATE_PIPE, s3c6410_g3d_create_pipe,
			DRM_UNLOCKED | DRM_AUTH | DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV(EXYNOS_G3D_DESTROY_PIPE, s3c6410_g3d_destroy_pipe,
			DRM_UNLOCKED | DRM_AUTH | DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV(EXYNOS_G3D_SUBMIT, s3c6410_g3d_submit,
			DRM_UNLOCKED | DRM_AUTH | DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV(EXYNOS_G3D_WAIT, s3c6410_g3d_wait,
			DRM_UNLOCKED | DRM_AUTH | DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV(EXYNOS_G3D_CPU_PREP, s3c6410_g3d_cpu_prep,
			DRM_UNLOCKED | DRM_AUTH | DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV(EXYNOS_G3D_CPU_FINI, s3c6410_g3d_cpu_fini,
			DRM_UNLOCKED | DRM_AUTH | DRM_RENDER_ALLOW),
#endif
#ifdef CONFIG_DRM_EXYNOS_S3C6410_G2D
	DRM_IOCTL_DEF_DRV(EXYNOS_G2D_CREATE_PIPE, s3c6410_g2d_create_pipe,
			DRM_UNLOCKED | DRM_AUTH | DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV(EXYNOS_G2D_DESTROY_PIPE, s3c6410_g2d_destroy_pipe,
			DRM_UNLOCKED | DRM_AUTH | DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV(EXYNOS_G2D_SUBMIT, s3c6410_g2d_submit,
			DRM_UNLOCKED | DRM_AUTH | DRM_RENDER_ALLOW),
	DRM_IOCTL_DEF_DRV(EXYNOS_G2D_WAIT, s3c6410_g2d_wait,
			DRM_UNLOCKED | DRM_AUTH | DRM_RENDER_ALLOW),
#endif
};
