...
#define CODA_REG_BIT_STREAM_CTRL			0x10c
	#define CODA7_STREAM_BUF_PIC_RESET_OFFSET	4
	#define CODADX6_STREAM_BUF_PIC_RESET_OFFSET	3
	#define CODA7_STREAM_BUF_PIC_FLUSH_OFFSET	3
	#define CODADX6_STREAM_BUF_PIC_FLUSH_OFFSET	2
	#define CODA7_STREAM_BUF_DYNALLOC_EN_OFFSET	5
	#define CODADX6_STREAM_BUF_DYNALLOC_EN_OFFSET	4
	#define CODA_STREAM_CHKDIS_OFFSET		1
	#define CODA_STREAM_ENDIAN_SELECT_OFFSET	0
#define CODA_REG_BIT_FRAME_MEM_CTRL			0x110
	#define CODA_IMAGE_ENDIAN_SELECT		(1 << 0)
#define CODA_REG_BIT_BIT_STREAM_PARAM			0x114
	#define CODA_BIT_STREAM_END_OFFSET		2
	#define CODA_BIT_DEC_SEQ_INIT_ESCAPE		(1 << 0)
	#define CODAMFC_BIT_STREAM_END_OFFSET		0
#define CODA_REG_BIT_TEMP_BUF_ADDR			0x118
/* reserved on Coda MFC v1				0x118 */
#define CODAMFC_REG_BIT_WORK_BUF_CONFIG			0x11c
#define CODA_REG_BIT_RD_PTR(x)				(0x120 + 8 * (x))
#define CODA_REG_BIT_WR_PTR(x)				(0x124 + 8 * (x))
#define CODA_REG_BIT_FRM_DIS_FLG(x)			(0x150 + 4 * (x))
/* 0x150-0x15c is used on Coda MFC v1 for RD/WR ptrs of further instances */
...
#define CODA_REG_BIT_RUN_COMMAND			0x164
	...
	#define CODAMFC_COMMAND_SLEEP			10
	#define CODAMFC_COMMAND_WAKEUP			11
...
#define CODA_REG_BIT_RUN_COD_STD			0x16c
	...
	#define CODAMFC_MODE_DECODE_VC1			4
...
/* Following layout is not used on CODA MFC v1 */
...
/* Layout used on CODA MFC v1 */
#define CODAMFC_CMD_DEC_SEQ_PRO_BUF			0x18c
#define CODAMFC_CMD_DEC_SEQ_TMP_BUF_1			0x190
#define CODAMFC_CMD_DEC_SEQ_TMP_BUF_2			0x194
#define CODAMFC_CMD_DEC_SEQ_TMP_BUF_3			0x198
#define CODAMFC_CMD_DEC_SEQ_TMP_BUF_4			0x19c
#define CODAMFC_CMD_DEC_SEQ_TMP_BUF_5			0x1a0
#define CODAMFC_CMD_DEC_SEQ_START_BYTE			0x1a4
/* Common layout */
...
#define CODAMFC_RET_DEC_SEQ_TIME_RES			0x1d8
/* Layout below is not used on CODA MFC v1 */
...
/* Layout used on CODA MFC v1 (since FW 1.3.14) */
#define CODAMFC_RET_DEC_SEQ_CROP_LEFT_RIGHT		0x1dc
#define CODAMFC_RET_DEC_SEQ_CROP_TOP_BOTTOM		0x1e0
/* Common layout */
...
/* Layout used on CODA MFC v1 */
#define CODAMFC_CMD_DEC_PIC_DBK_ADDR_Y			0x190
#define CODAMFC_CMD_DEC_PIC_DBK_ADDR_CB			0x194
#define CODAMFC_CMD_DEC_PIC_DBK_ADDR_CR			0x198
#define CODAMFC_CMD_DEC_PIC_ROT_STRIDE			0x19c
#define CODAMFC_CMD_DEC_PIC_OPTION			0x1a0
#define CODAMFC_CMD_DEC_PIC_CHUNK_SIZE			0x1a8
#define CODAMFC_CMD_DEC_PIC_BB_START			0x1ac
#define CODAMFC_CMD_DEC_PIC_START_BYTE			0x1b0
#define CODAMFC_CMD_DEC_PIC_MV_ADDR			0x1b4
#define CODAMFC_CMD_DEC_PIC_MBTYPE_ADDR			0x1b8
/* Common layout */
...
/* Layout used on CODA MFC v1 */
#define CODAMFC_RET_DEC_PIC_FCODE_FWD			0x1e0
#define CODAMFC_RET_DEC_PIC_TRD				0x1e4
#define CODAMFC_RET_DEC_PIC_TIME_BASE_LAST		0x1e8
#define CODAMFC_RET_DEC_PIC_NONB_TIME_LAST		0x1ec
#define CODAMFC_RET_DEC_PIC_BCNT			0x1f0
/* Common layout */
...
#define CODA_CMD_ENC_SEQ_MP4_PARA			0x198
	...
	#define CODA_MP4PARAM_REVERSIBLEVLCEN_OFFSET	1
	#define CODA_MP4PARAM_REVERSIBLEVLCEN_MASK	0x01
	#define CODA_MP4PARAM_DATAPARTITIONEN_OFFSET	0
	#define CODA_MP4PARAM_DATAPARTITIONEN_MASK	0x01
#define CODA_CMD_ENC_SEQ_263_PARA			0x19c
	#define CODA_263PARAM_ANNEXIENABLE_OFFSET	3
	#define CODA_263PARAM_ANNEXIENABLE_MASK		0x01
...
#define CODA_CMD_ENC_SEQ_264_PARA			0x1a0
	#define CODA_264PARAM_DBLKFLTOFFSBETA_OFFSET	12
	#define CODA_264PARAM_DBLKFLTOFFSBETA_MASK	0x0f
	#define CODA_264PARAM_DBLKFLTOFFSALPHA_OFFSET	8
	#define CODA_264PARAM_DBLKFLTOFFSALPHA_MASK	0x0f
	#define CODA_264PARAM_DIS_DBLK_OFFSET		6
	#define CODA_264PARAM_DIS_DBLK_MASK		0x01
	#define CODA_264PARAM_CONSTRINTRAPRED_OFFSET	5
	#define CODA_264PARAM_CONSTRINTRAPRED_MASK	0x01
...
/* Layout used on CODA MFC v1 */
#define CODAMFC_CMD_ENC_SEQ_TMP_BUF_1			0x1d0
#define CODAMFC_CMD_ENC_SEQ_TMP_BUF_2			0x1d4
#define CODAMFC_CMD_ENC_SEQ_TMP_BUF_3			0x1d8
#define CODAMFC_CMD_ENC_SEQ_TMP_BUF_4			0x1dc
/* Common layout */
...
#define CODAMFC_CMD_ENC_HEADER_NUM			0x18c
...
#define CODA_FIRMWARE_VERNUM(prod, maj, min, rel)	\
	((prod) << 16 | ((maj) << 12) |			\
	((min) << 8) | (rel))
