...
static struct samsung_pin_bank s5p6442_pin_banks[] = {
	...
	EXYNOS_PIN_BANK_EINTN(4, 0x2c0, "mp02"),
	EXYNOS_PIN_BANK_EINTN(5, 0x2e0, "mp03"),
	EXYNOS_PIN_BANK_EINTN(8, 0x300, "mp04"),
	EXYNOS_PIN_BANK_EINTN(8, 0x320, "mp05"),
	EXYNOS_PIN_BANK_EINTN(8, 0x340, "mp06"),
	EXYNOS_PIN_BANK_EINTN(8, 0x360, "mp07"),
	EXYNOS_PIN_BANK_EINTN(8, 0x380, "mp10"),
	EXYNOS_PIN_BANK_EINTN(4, 0x3a0, "mp11"),
	EXYNOS_PIN_BANK_EINTN(8, 0x3c0, "mp12"),
	EXYNOS_PIN_BANK_EINTN(8, 0x3e0, "mp13"),
	EXYNOS_PIN_BANK_EINTN(8, 0x400, "mp14"),
	EXYNOS_PIN_BANK_EINTN(8, 0x420, "mp15"),
	EXYNOS_PIN_BANK_EINTN(8, 0x440, "mp16"),
	EXYNOS_PIN_BANK_EINTN(8, 0x460, "mp17"),
	EXYNOS_PIN_BANK_EINTN(7, 0x480, "mp18"),
...
struct samsung_pin_ctrl s5p6442_pin_ctrl[] = {
	{
		/* pin-controller instance 0 data */
		.pin_banks	= s5p6442_pin_banks,
		.nr_banks	= ARRAY_SIZE(s5p6442_pin_banks),
